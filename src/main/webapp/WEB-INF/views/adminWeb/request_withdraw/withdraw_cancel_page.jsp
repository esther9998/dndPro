...
<div class="withdraw_wrap" id="withdraw_wrap">
	<div style="position:relative; margin-left:100px; margin-right:100px; top:35px;">
		<div style="">
			<table style="font-size:12px; border-spacing:0px;" width=400px; >
				...
				<tr>
					...
					<td class="withdraw_content">[ ${WITHDRAW_ADDR} ]   ${WITHDRAW_TADDR}</td>
				</tr>
				<tr>
			...
			<div style="font-size:12px; text-align:left; margin-top:20px; text-align:center;">
				<div style="display:inline-block;">사유 : 
					<div style="display:inline-block; margin-left:20px;"><input type="text" size=30; id="cancel_reason"></div>
					<div style="margin-top:10px; font-size:11px; color:red;"> * 육하원칙으로 작성해주시기 바랍니다.</div>
					<div style="margin-top:3px; font-size:11px;"> ex) 2017년 05월 31일 11시 30분 OOO 전화통화 후, 취소 요청으로 인한 취소</div>
				</div>
			</div>
		</div>
		...
		<div style="margin-top:25px; text-align:center;">
			<div class="withdraw_cancel" id="withdraw_cancel">출금취소</div>
