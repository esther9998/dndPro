...
$(document).ready( function() {
	...
	$(document).off('click','#withdrawList_admin td #withdraw_taddr_btn');
	$(document).off('click','#Pop_close');
	
	$('#withdrawList_admin tbody').off( 'click', 'tr');
	
	WithdrawalListTable = $("#withdrawList_admin").DataTable({
    
	    "language": {
   		    "emptyTable": "등록된 입·출금이 없습니다.",
   			"zeroRecords": "검색된 입·출금이 없습니다.",
	        paginate:
	        {
	            previous: "<",
	            next: ">",
...
// 	$(document).on('click','#withdrawList td #withdraw_taddr_btn',function(){
//     	var row_data = $(this).closest('tr');
// 	    MEMBER_NUM = WithdrawalListTable.row(row_data).data()['MEMBER_NUM'];
// 	    BANKING_NUM = WithdrawalListTable.row(row_data).data()['BANKING_NUM'];
...
<div class="withdrawList_wrap" id="withdrawList_wrap">
	...
	<div style="position:relative; top:20px;">
		<table id="withdrawList_admin" class="display" cellspacing="0" width="100%;" height="80%;">
		        <thead>
